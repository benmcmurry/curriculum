 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', 'http://elc.byu.edu/curriculum/images/');

/**
 * Deafult image logo used be the default Header() method.
 * Please set here your own logo or an empty string to disable it.
 */
define ('PDF_HEADER_LOGO', 'box-logo.jpg');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'English Language Center');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'English Language Center');
 ...
 */
define ('PDF_HEADER_STRING', "http://elc.byu.edu/curriculum/");
